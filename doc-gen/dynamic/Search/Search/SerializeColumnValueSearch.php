...
/// 
/// # Params
/// @param [(0)!in] params                                            <ul><li>type: hash</li><li>[中文(傳統)] 所有必要的 parameters, 請參考 search 裡的 column_value</li><li>see: dynamic:: Search.php</li></ul>
...
/// 
//////////
function SerializeColumnValueSearch(&$params) {
  global $NoSQL;
