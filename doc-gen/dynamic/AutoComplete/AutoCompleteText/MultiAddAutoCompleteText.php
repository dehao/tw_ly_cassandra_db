...
/// #### More<br />
/// 最單純的 call: MultiAddAutoCompleteText($params, "", "", null, false, false);<br />
/// <br />
///
/// 
...
/// 
/// # Params
/// @param [(0)!in] &$params                                          <ul><li>type: hash</li><li>[中文(傳統)] 整理好的要做 update 的 rows. 以 array(key => array(column_name => column_value)) 表示. 請參考 auto_complete_text 裡的 key/column_name/column_value</li><li>see: dynamic:: AutoCompleteText.php</li></ul>
