...
/// @param [=out] str                                                 <ul><li>type: hash</li><li>[中文(傳統)] key 的 structure, 請參考 auto_complete_text 的 key 的部份</li><li>see: dynamic:: AutoCompleteText.php</li></ul>
/// 
/// # DO
/// 1. 如果只有一個的話. 直接設定傳回.
/// 2. 如果有很多個的話. 
...
/// 
//////////
function UnserializeKeyAutoCompleteText(&$params) {
  global $NoSQL;
