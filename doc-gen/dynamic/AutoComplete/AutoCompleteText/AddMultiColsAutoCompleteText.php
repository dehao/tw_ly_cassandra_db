...
/// # DealWith
//////////
function AddMultiColsAutoCompleteText(&$params, $ttl = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if(!isset($params['text_ids'])) {
    $result['error'] = ErrorCode('AUTO_COMPLETE_TEXT', $function_name, 'API1_NO_IDS');
    return $result;
  }
  ...
  foreach($params['text_ids'] as $each_val) {
    ...
    if($is_check_params && $result_check_params = AddAutoCompleteTextCheckParams($params)) {
