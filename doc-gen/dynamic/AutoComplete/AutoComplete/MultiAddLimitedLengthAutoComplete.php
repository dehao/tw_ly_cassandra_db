...
//////////
/// # MEMO
/// 如果 AutoComplete 本身是有限長度的. 用 MultiAddLimitedLengthAutoComplete 將多個 keys 增加到 AutoComplete. <br />
/// <br />
///
/// 
...
/// @param [(1)=in] $col_start = ""                                   <ul><li>type: string</li><li>[中文(傳統)] 在跟已經存在 auto_complete 裡的 column_name 比較(要刪除)的時候. 要從哪裡開始比 (區間裡小的那個)</li></ul>
/// @param [(2)=in] $col_end = ""                                     <ul><li>type: string</li><li>[中文(傳統)] 在跟已經存在 auto_complete 裡的 column_name 比較(要刪除)的時候, 比較的結束點 (區間裡大的那個)</li></ul>
