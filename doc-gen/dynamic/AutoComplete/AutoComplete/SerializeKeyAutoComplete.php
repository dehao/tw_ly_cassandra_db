...
/// 
/// # Params
/// @param [(0)!in] params                                            <ul><li>type: hash</li><li>[中文(傳統)] 所有必要的 parameters, 請參考 auto_complete 裡的 key</li><li>see: dynamic:: AutoComplete.php</li></ul>
...
/// 
//////////
function SerializeKeyAutoComplete(&$params) {
  global $NoSQL;
