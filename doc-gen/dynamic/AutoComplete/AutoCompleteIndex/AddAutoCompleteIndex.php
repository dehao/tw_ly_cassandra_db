...
/// @param [=in] $params['cols'] = [not_isset]                        <ul><li>type: string</li><li>[中文(傳統)] 以 array(column_name_id => column_value_id) 表示的 cols. (column_name_id 和 column_value_id 可以用 SerializeColumnNameAutoCompleteIndex 和 SerializeColumnValueAutoCompleteIndex 取得) (適用於對於同 1 個 key add 很多個 cols.)</li></ul>
