...
/// 
//////////
function MultiGetCountSearchRelatedIndex($params, $key_ids, $cols = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "") {
  global $NoSQL;
  ...
  $data = MultiGetCount($cf_search_related_index, $key_ids, $cols, $is_reverse, $max_length, $col_start, $col_end);
  if($data === null) {
    $result['error'] = ErrorCode('SEARCH_RELATED_INDEX', $function_name, 'MULTIGET_COUNT');
