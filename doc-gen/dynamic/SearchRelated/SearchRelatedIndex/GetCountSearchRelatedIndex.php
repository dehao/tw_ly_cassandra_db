...
/// 
//////////
function GetCountSearchRelatedIndex($params, $key_id, $cols = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "") {
  global $NoSQL;
  ...
  $data = GetCount($cf_search_related_index, $key_id, $cols, $is_reverse, $max_length, $col_start, $col_end);
  if($data === null) {
    $result['error'] = ErrorCode('SEARCH_RELATED_INDEX', $function_name, 'GET_COUNT');
    $result['result'] = 0;
    return $result;
  }
