...
/// </li>
/// <li>auto_complete_text:   <ul><li>[中文(傳統)] auto complete 相關的 list</li></ul>
/// </li></ul>
/// @param [base_type] common_dynamic
/// @param [base_type] search_related
/// @param [base_type] auto_complete
...
///                                                                   </ul></li>
///                                                                   </ul>
/// @param [cf_info] <ul><li>CF => auto_complete_text</li><li>SET_CF => auto_complete_text</li><li>SECOND_CF => text</li><li>SET_SECOND_CF => text</li><li>COUNT_CF => auto_complete</li><li>SET_COUNT_CF => auto_complete</li><li>COUNT_COLUMN => text</li><li>LENGTH => 100</li></ul>
///////////
function AutoCompleteTextAjax() {
}
?>
