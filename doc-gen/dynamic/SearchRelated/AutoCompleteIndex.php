...
/// </li>
/// <li>search_related_index:   <ul></ul>
/// </li>
/// <li>auto_complete_index:   <ul><li>[中文(傳統)] 所有 dynamic 的共同基本資訊 (不能直接把 auto_complete_id 放在這裡的 key. 因為有 system_all.</li></ul>
/// </li></ul>
/// @param [base_type] common_dynamic
/// @param [base_type] search_related_index
...
///                                                                   </ul></li>
///                                                                   </ul>
/// @param [cf_info] <ul><li>CF => auto_complete_index</li><li>SET_CF => auto_complete_index</li><li>SECOND_CF => index</li><li>SET_SECOND_CF => index</li><li>COUNT_CF => auto_complete</li><li>SET_COUNT_CF => auto_complete</li><li>COUNT_COLUMN => index</li><li>LENGTH => 100</li></ul>
///////////
function AutoCompleteIndexAjax() {
}
?>
