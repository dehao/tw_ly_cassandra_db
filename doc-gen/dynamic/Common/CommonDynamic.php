...
/// CommonDynamic
/// @memo <ul>
/// <li>common_dynamic:   <ul><li>[中文(傳統)] 所有 dynamic 的共同基本資訊 (不能直接把 common_id 放在這裡的 key. 因為有 system_all.</li></ul>
/// </li></ul>
///
///
...
///                                                                   </ul></li>
///                                                                   </ul>
/// @param [cf_info] <ul><li>CF => common_dynamic</li><li>SET_CF => common_dynamic</li><li>SECOND_CF => dynamic</li><li>SET_SECOND_CF => dynamic</li><li>COUNT_CF => common</li><li>SET_COUNT_CF => common</li><li>COUNT_COLUMN => dynamic</li><li>LENGTH => 100</li></ul>
///////////
function CommonDynamicAjax() {
}
?>
