...
/// AutoComplete
/// @memo <ul>
/// <li>common_dynamic:   <ul><li>[中文(傳統)] 所有 dynamic 的共同基本資訊 (不能直接把 auto_complete_id 放在這裡的 key. 因為有 system_all.</li></ul>
/// </li>
/// <li>search_related:   <ul><li>[中文(傳統)] search 相關的 list</li></ul>
/// </li>
/// <li>auto_complete:   <ul><li>[中文(傳統)] auto complete 相關的 list</li></ul>
/// </li></ul>
...
/// @param [column_name] auto_complete_id                             <ul><li>type: key</li><li>[中文(傳統)] 相對應的 auto_complete id</li></ul>
...
/// @param [column_value] auto_complete_id                            <ul><li>type: key</li><li>[中文(傳統)] 相對應的 auto_complete id</li></ul>
...
///                                                                   </ul></li>
///                                                                   </ul>
/// @param [cf_info] <ul><li>CF => auto_complete</li><li>SET_CF => auto_complete</li><li>SECOND_CF => auto_complete</li><li>SET_SECOND_CF => auto_complete</li><li>COUNT_CF => auto_complete</li><li>SET_COUNT_CF => auto_complete</li><li>COUNT_COLUMN => auto_complete</li><li>LENGTH => 100</li></ul>
///////////
