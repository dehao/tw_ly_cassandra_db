...
/// @param [column_name] search_id                                    <ul><li>type: key</li><li>[中文(傳統)] 相對應的 search id</li></ul>
...
/// @param [column_value] search_id                                   <ul><li>type: key</li><li>[中文(傳統)] 相對應的 search id</li></ul>
...
///                                                                   </ul></li>
///                                                                   </ul>
/// @param [cf_info] <ul><li>CF => search</li><li>SET_CF => search</li><li>SECOND_CF => search</li><li>SET_SECOND_CF => search</li><li>COUNT_CF => search</li><li>SET_COUNT_CF => search</li><li>COUNT_COLUMN => search</li><li>LENGTH => 100</li></ul>
///////////
function SearchAjax() {
}
?>
