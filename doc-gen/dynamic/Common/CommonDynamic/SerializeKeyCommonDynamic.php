...
/// 
/// # Params
/// @param [(0)!in] params                                            <ul><li>type: hash</li><li>[中文(傳統)] 所有必要的 parameters, 請參考 common_dynamic 裡的 key</li><li>see: dynamic:: CommonDynamic.php</li></ul>
...
/// 
//////////
function SerializeKeyCommonDynamic(&$params) {
  global $NoSQL;
