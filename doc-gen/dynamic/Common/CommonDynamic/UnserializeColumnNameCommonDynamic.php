...
/// @param [=out] str                                                 <ul><li>type: hash</li><li>[中文(傳統)] column_name 的 structure, 請參考 common_dynamic 的 column_name 的部份</li><li>see: dynamic:: CommonDynamic.php</li></ul>
/// 
/// # DO
/// 1. 如果只有一個的話. 直接設定傳回.
/// 2. 如果有很多個的話. 
...
/// 
//////////
function UnserializeColumnNameCommonDynamic(&$params) {
  global $NoSQL;
