...
/// 
//////////
function MultiGetCountCommonDynamic($params, $key_ids, $cols = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "") {
  global $NoSQL;
  ...
  $data = MultiGetCount($cf_common_dynamic, $key_ids, $cols, $is_reverse, $max_length, $col_start, $col_end);
  if($data === null) {
    $result['error'] = ErrorCode('COMMON_DYNAMIC', $function_name, 'MULTIGET_COUNT');
