...
<?php include_once('SearchRelated/SearchRelated/AddSearchRelated/AddSearchRelatedCheckParams.php'); ?>
<?php include_once('SearchRelated/SearchRelated/AddSearchRelated/AddSearchRelatedDealWith.php'); ?>
...
///////////
function AddMultiColsSearchRelated(&$params, $ttl = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if(!isset($params['search_related_ids'])) {
    $result['error'] = ErrorCode('SEARCH_RELATED', $function_name, 'API1_NO_IDS');
    return $result;
  }
  ...
  foreach($params['search_related_ids'] as $each_val) {
    $params['search_related_id'] = $each_val;
    if($is_check_params && $result_check_params = AddSearchRelatedCheckParams($params)) {
