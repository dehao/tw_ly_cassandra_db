...
<?php include_once('SearchRelated/SearchRelatedIndex/GetSearchRelatedIndex/GetSearchRelatedIndexCheckParams.php'); ?>
...
/**********
 * # MEMO
 * 拿到 SearchRelatedIndex (require: params['key_id'])
 * 
 * # DO
