...
<?php include_once('SearchRelated/SearchRelatedIndex/AddLimitedLengthSearchRelatedIndex/AddLimitedLengthSearchRelatedIndexCheckParams.php'); ?>
<?php include_once('SearchRelated/SearchRelatedIndex/ParseNewObjSearchRelatedIndex.php'); ?>
<?php ?>
<?php include_once('SearchRelated/SearchRelatedIndex/GetSearchRelatedIndex.php'); ?>
<?php include_once('SearchRelated/SearchRelatedIndex/GetCountSearchRelatedIndex.php'); ?>
...
/**********
 * # MEMO
 * 如果 SearchRelatedIndex 本身是有限長度的. 用 AddLimitedLengthSearchRelatedIndex 增加到 SearchRelatedIndex. 
 * 
/// #### GENERAL REQUIRE
...
* 4. 拿到原本的 array. (GetSearchRelatedIndex 目前 policy: 因為長度是有限的. 而且是 add. 所以就全拿. (如果太多的話. 要考慮比較好的縮短長度的方法))
