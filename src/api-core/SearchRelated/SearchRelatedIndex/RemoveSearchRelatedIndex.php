...
<?php include_once('SearchRelated/SearchRelatedIndex/RemoveSearchRelatedIndex/RemoveSearchRelatedIndexCheckParams.php'); ?>
<?php include_once('SearchRelated/SearchRelatedIndex/RemoveSearchRelatedIndex/RemoveSearchRelatedIndexDealWith.php'); ?>
...
/**********
 * # MEMO
 * 從 search_related_index 刪除 data (dynamic 是直接刪除)
 * 
 * # DO
 ...
 */
function RemoveSearchRelatedIndex(&$params, $key_id, $column_names = null, $params_orig = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if($is_check_params && $result_check_params = RemoveSearchRelatedIndexCheckParams($key_id, $column_names, $params, $result)) {
   ...
   */
  if($params_orig === null) {
    $params_orig = GetData($cf_search_related_index, $key_id, $column_names);
  }

  if(RemoveData($cf_search_related_index, $key_id, $column_names)) {
   ...
   */
  if($is_deal_with && $result_deal_with = RemoveSearchRelatedIndexDealWith($key_id, $column_names, $params_orig, $result, $params)) {
