...
<?php include_once('AutoComplete/AutoCompleteText/AddLimitedLengthAutoCompleteText/AddLimitedLengthAutoCompleteTextCheckParams.php'); ?>
...
<?php include_once('AutoComplete/AutoCompleteText/GetCountAutoCompleteText.php'); ?>
...
/**********
 * # MEMO
 * 如果 AutoCompleteText 本身是有限長度的. 用 AddLimitedLengthAutoCompleteText 增加到 AutoCompleteText. 
 * 
/// #### GENERAL REQUIRE
...
* 4. 拿到原本的 array. (GetAutoCompleteText 目前 policy: 因為長度是有限的. 而且是 add. 所以就全拿. (如果太多的話. 要考慮比較好的縮短長度的方法))
