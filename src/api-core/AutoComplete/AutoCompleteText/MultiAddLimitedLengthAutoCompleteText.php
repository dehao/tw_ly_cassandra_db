...
<?php include_once('AutoComplete/AutoCompleteText/MultiAddLimitedLengthAutoCompleteText/MultiAddLimitedLengthAutoCompleteTextCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoCompleteText/ParseNewObjAutoCompleteText.php'); ?>
<?php ?>
<?php include_once('AutoComplete/AutoCompleteText/MultiGetAutoCompleteText.php'); ?>
<?php include_once('AutoComplete/AutoCompleteText/MultiGetCountAutoCompleteText.php'); ?>
...
/**********
 * # MEMO
 * 如果 AutoCompleteText 本身是有限長度的. 用 MultiAddLimitedLengthAutoCompleteText 將多個 keys 增加到 AutoCompleteText. 
 *
 * # DO
