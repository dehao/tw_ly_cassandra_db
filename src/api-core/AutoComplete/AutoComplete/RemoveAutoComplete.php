...
<?php include_once('AutoComplete/AutoComplete/RemoveAutoComplete/RemoveAutoCompleteCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoComplete/RemoveAutoComplete/RemoveAutoCompleteDealWith.php'); ?>
...
/**********
 * # MEMO
 * 從 auto_complete 刪除 data (dynamic 是直接刪除)
 * 
 * # DO
 ...
 */
function RemoveAutoComplete(&$params, $key_id, $column_names = null, $params_orig = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if($is_check_params && $result_check_params = RemoveAutoCompleteCheckParams($key_id, $column_names, $params, $result)) {
   ...
   */
  if($params_orig === null) {
    $params_orig = GetData($cf_auto_complete, $key_id, $column_names);
  }

  if(RemoveData($cf_auto_complete, $key_id, $column_names)) {
   ...
   */
  if($is_deal_with && $result_deal_with = RemoveAutoCompleteDealWith($key_id, $column_names, $params_orig, $result, $params)) {
