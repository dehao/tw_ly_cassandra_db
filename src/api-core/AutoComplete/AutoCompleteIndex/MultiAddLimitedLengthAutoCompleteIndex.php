...
<?php include_once('AutoComplete/AutoCompleteIndex/MultiAddLimitedLengthAutoCompleteIndex/MultiAddLimitedLengthAutoCompleteIndexCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/ParseNewObjAutoCompleteIndex.php'); ?>
<?php ?>
<?php include_once('AutoComplete/AutoCompleteIndex/MultiGetAutoCompleteIndex.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/MultiGetCountAutoCompleteIndex.php'); ?>
...
/**********
 * # MEMO
 * 如果 AutoCompleteIndex 本身是有限長度的. 用 MultiAddLimitedLengthAutoCompleteIndex 將多個 keys 增加到 AutoCompleteIndex. 
 *
 * # DO
