...
<?php include_once('AutoComplete/AutoCompleteIndex/GetAutoCompleteIndex.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/RemoveAutoCompleteIndex/RemoveAutoCompleteIndexCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/RemoveAutoCompleteIndex/RemoveAutoCompleteIndexDealWith.php'); ?>
...
/**********
 * # MEMO
 * 從 auto_complete_index 刪除 data (dynamic 是直接刪除)
 * 
 * # DO
 ...
 */
function RemoveAutoCompleteIndex(&$params, $key_id, $column_names = null, $params_orig = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if($is_check_params && $result_check_params = RemoveAutoCompleteIndexCheckParams($key_id, $column_names, $params, $result)) {
   ...
   */
  if($params_orig === null) {
    $params_orig = GetData($cf_auto_complete_index, $key_id, $column_names);
  }

  if(RemoveData($cf_auto_complete_index, $key_id, $column_names)) {
   ...
   */
  if($is_deal_with && $result_deal_with = RemoveAutoCompleteIndexDealWith($key_id, $column_names, $params_orig, $result, $params)) {
