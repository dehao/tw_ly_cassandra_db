...
<?php include_once('AutoComplete/AutoCompleteIndex/AddLimitedLengthAutoCompleteIndex/AddLimitedLengthAutoCompleteIndexCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/ParseNewObjAutoCompleteIndex.php'); ?>
<?php ?>
<?php include_once('AutoComplete/AutoCompleteIndex/GetAutoCompleteIndex.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/GetCountAutoCompleteIndex.php'); ?>
...
/**********
 * # MEMO
 * 如果 AutoCompleteIndex 本身是有限長度的. 用 AddLimitedLengthAutoCompleteIndex 增加到 AutoCompleteIndex. 
 * 
/// #### GENERAL REQUIRE
/// 1. params['key_id']/(表示 key 的 id (請參考 dynamic::auto_complete_index))
/// 2. 除非有在 dynamic::auto_complete_index 特別說明. 否則 column_name/column_value 裡的 structure 都需要設定. 
...
* 4. 拿到原本的 array. (GetAutoCompleteIndex 目前 policy: 因為長度是有限的. 而且是 add. 所以就全拿. (如果太多的話. 要考慮比較好的縮短長度的方法))
