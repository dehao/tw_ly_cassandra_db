...
<?php include_once('AutoComplete/AutoCompleteIndex/AddAutoCompleteIndex/AddAutoCompleteIndexCheckParams.php'); ?>
<?php include_once('AutoComplete/AutoCompleteIndex/AddAutoCompleteIndex/AddAutoCompleteIndexDealWith.php'); ?>
...
///////////
function AddAutoCompleteIndex(&$params, $ttl = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if(isset($params['cols'])) {
    ...
    //1.2
    if($is_check_params && $result_check_params = AddAutoCompleteIndexCheckParams($params, $result)) {
