...
<?php include_once('Common/CommonDynamic/RemoveCommonDynamic/RemoveCommonDynamicCheckParams.php'); ?>
<?php include_once('Common/CommonDynamic/RemoveCommonDynamic/RemoveCommonDynamicDealWith.php'); ?>
...
/**********
 * # MEMO
 * 從 common_dynamic 刪除 data (dynamic 是直接刪除)
 * 
 * # DO
 ...
 */
function RemoveCommonDynamic(&$params, $key_id, $column_names = null, $params_orig = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if($is_check_params && $result_check_params = RemoveCommonDynamicCheckParams($key_id, $column_names, $params, $result)) {
   ...
   */
  if($params_orig === null) {
    $params_orig = GetData($cf_common_dynamic, $key_id, $column_names);
  }

  if(RemoveData($cf_common_dynamic, $key_id, $column_names)) {
   ...
   */
  if($is_deal_with && $result_deal_with = RemoveCommonDynamicDealWith($key_id, $column_names, $params_orig, $result, $params)) {
