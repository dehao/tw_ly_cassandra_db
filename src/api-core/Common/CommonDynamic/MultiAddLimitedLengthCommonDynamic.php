...
<?php include_once('Common/CommonDynamic/MultiAddLimitedLengthCommonDynamic/MultiAddLimitedLengthCommonDynamicCheckParams.php'); ?>
<?php include_once('Common/CommonDynamic/ParseNewObjCommonDynamic.php'); ?>
<?php ?>
<?php include_once('Common/CommonDynamic/MultiGetCommonDynamic.php'); ?>
<?php include_once('Common/CommonDynamic/MultiGetCountCommonDynamic.php'); ?>
...
/**********
 * # MEMO
 * 如果 CommonDynamic 本身是有限長度的. 用 MultiAddLimitedLengthCommonDynamic 將多個 keys 增加到 CommonDynamic. 
 *
 * # DO
