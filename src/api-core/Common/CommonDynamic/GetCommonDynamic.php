...
<?php include_once('Common/CommonDynamic/GetCommonDynamic/GetCommonDynamicCheckParams.php'); ?>
...
/**********
 * # MEMO
 * 拿到 CommonDynamic (require: params['key_id'])
 * 
 * # DO
 ...
 */
function GetCommonDynamic(&$params, $key_id, $column_names = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "", $is_with_start = false, $is_check_available = true) {
  global $NoSQL;
  ...
  if($result_check_params = GetCommonDynamicCheckParams($params, $key_id, $column_names, $is_reverse, $max_length, $col_start, $col_end, $is_with_start, $is_check_available, $result)) {
  ...
  $data = GetData($cf_common_dynamic, $key_id, $column_names, $is_reverse, $max_length, $col_start, $col_end);
  Debug("INFO", __LINE__ . $DEBUG_FILENAME, "after GetData: data", $data);
  if($data === null) {
    //$result['error'] = ErrorCode('COMMON_DYNAMIC', $function_name, 'GET');
    //return $result;
    $result['result'] = array();
    return $result;
  }
