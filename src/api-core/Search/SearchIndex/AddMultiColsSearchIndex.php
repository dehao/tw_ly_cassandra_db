...
<?php include_once('Search/SearchIndex/AddSearchIndex/AddSearchIndexCheckParams.php'); ?>
<?php include_once('Search/SearchIndex/AddSearchIndex/AddSearchIndexDealWith.php'); ?>
<?php include_once('Search/SearchIndex/SerializeKeySearchIndex.php'); ?>
<?php include_once('Search/SearchIndex/SerializeColumnNameSearchIndex.php'); ?>
<?php include_once('Search/SearchIndex/SerializeColumnValueSearchIndex.php'); ?>
...
///////////
function AddMultiColsSearchIndex(&$params, $ttl = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if(!isset($params['index_ids'])) {
    $result['error'] = ErrorCode('SEARCH_INDEX', $function_name, 'API1_NO_IDS');
    return $result;
  }
  ...
  foreach($params['index_ids'] as $each_val) {
    ...
    if($is_check_params && $result_check_params = AddSearchIndexCheckParams($params)) {
