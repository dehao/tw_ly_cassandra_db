...
<?php include_once('Search/SearchIndex/MultiAddLimitedLengthSearchIndex/MultiAddLimitedLengthSearchIndexCheckParams.php'); ?>
<?php include_once('Search/SearchIndex/ParseNewObjSearchIndex.php'); ?>
<?php ?>
<?php include_once('Search/SearchIndex/MultiGetSearchIndex.php'); ?>
<?php include_once('Search/SearchIndex/MultiGetCountSearchIndex.php'); ?>
...
/**********
 * # MEMO
 * 如果 SearchIndex 本身是有限長度的. 用 MultiAddLimitedLengthSearchIndex 將多個 keys 增加到 SearchIndex. 
 *
 * # DO
