...
<?php include_once('Search/SearchIndex/AddLimitedLengthSearchIndex/AddLimitedLengthSearchIndexCheckParams.php'); ?>
<?php include_once('Search/SearchIndex/ParseNewObjSearchIndex.php'); ?>
<?php ?>
...
/**********
 * # MEMO
 * 如果 SearchIndex 本身是有限長度的. 用 AddLimitedLengthSearchIndex 增加到 SearchIndex. 
 * 
/// #### GENERAL REQUIRE
/// 1. params['key_id']/(表示 key 的 id (請參考 dynamic::search_index))
/// 2. 除非有在 dynamic::search_index 特別說明. 否則 column_name/column_value 裡的 structure 都需要設定. 
...
* 4. 拿到原本的 array. (GetSearchIndex 目前 policy: 因為長度是有限的. 而且是 add. 所以就全拿. (如果太多的話. 要考慮比較好的縮短長度的方法))
