...
<?php include_once('Search/SearchIndex/RemoveSearchIndex/RemoveSearchIndexCheckParams.php'); ?>
<?php include_once('Search/SearchIndex/RemoveSearchIndex/RemoveSearchIndexDealWith.php'); ?>
...
/**********
 * # MEMO
 * 從 search_index 刪除 data (dynamic 是直接刪除)
 * 
 * # DO
 ...
 */
function RemoveSearchIndex(&$params, $key_id, $column_names = null, $params_orig = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if($is_check_params && $result_check_params = RemoveSearchIndexCheckParams($key_id, $column_names, $params, $result)) {
   ...
   */
  if($params_orig === null) {
    $params_orig = GetData($cf_search_index, $key_id, $column_names);
  }

  if(RemoveData($cf_search_index, $key_id, $column_names)) {
   ...
   */
  if($is_deal_with && $result_deal_with = RemoveSearchIndexDealWith($key_id, $column_names, $params_orig, $result, $params)) {
