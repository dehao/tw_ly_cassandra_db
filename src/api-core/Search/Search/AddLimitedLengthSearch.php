...
<?php include_once('Search/Search/AddLimitedLengthSearch/AddLimitedLengthSearchCheckParams.php'); ?>
<?php include_once('Search/Search/ParseNewObjSearch.php'); ?>
<?php ?>
<?php include_once('Search/Search/GetSearch.php'); ?>
<?php include_once('Search/Search/GetCountSearch.php'); ?>
...
/**********
 * # MEMO
 * 如果 Search 本身是有限長度的. 用 AddLimitedLengthSearch 增加到 Search. 
 * 
/// #### GENERAL REQUIRE
...
* 4. 拿到原本的 array. (GetSearch 目前 policy: 因為長度是有限的. 而且是 add. 所以就全拿. (如果太多的話. 要考慮比較好的縮短長度的方法))
