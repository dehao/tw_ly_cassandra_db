...
<?php include_once('Search/Search/MultiAddLimitedLengthSearch/MultiAddLimitedLengthSearchCheckParams.php'); ?>
<?php include_once('Search/Search/ParseNewObjSearch.php'); ?>
<?php ?>
<?php include_once('Search/Search/MultiGetSearch.php'); ?>
<?php include_once('Search/Search/MultiGetCountSearch.php'); ?>
...
/**********
 * # MEMO
 * 如果 Search 本身是有限長度的. 用 MultiAddLimitedLengthSearch 將多個 keys 增加到 Search. 
 *
 * # DO
