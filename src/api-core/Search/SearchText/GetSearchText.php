...
<?php include_once('Search/SearchText/GetSearchText/GetSearchTextCheckParams.php'); ?>
...
/**********
 * # MEMO
 * 拿到 SearchText (require: params['key_id'])
 * 
 * # DO
 ...
 */
function GetSearchText(&$params, $key_id, $column_names = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "", $is_with_start = false, $is_check_available = true) {
  global $NoSQL;
  ...
  if($result_check_params = GetSearchTextCheckParams($params, $key_id, $column_names, $is_reverse, $max_length, $col_start, $col_end, $is_with_start, $is_check_available, $result)) {
