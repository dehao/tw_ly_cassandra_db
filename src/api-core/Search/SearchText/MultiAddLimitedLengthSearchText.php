...
<?php include_once('Search/SearchText/MultiAddLimitedLengthSearchText/MultiAddLimitedLengthSearchTextCheckParams.php'); ?>
<?php include_once('Search/SearchText/ParseNewObjSearchText.php'); ?>
<?php ?>
<?php include_once('Search/SearchText/MultiGetSearchText.php'); ?>
...
/**********
 * # MEMO
 * 如果 SearchText 本身是有限長度的. 用 MultiAddLimitedLengthSearchText 將多個 keys 增加到 SearchText. 
 *
 * # DO
