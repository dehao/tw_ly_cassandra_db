...
function GetCountSearchText($params, $key_id, $cols = null, $is_reverse = true, $max_length = LENGTH_GET_DATA, $col_start = "", $col_end = "") {
  global $NoSQL;
  ...
  $data = GetCount($cf_search_text, $key_id, $cols, $is_reverse, $max_length, $col_start, $col_end);
  if($data === null) {
    $result['error'] = ErrorCode('SEARCH_TEXT', $function_name, 'GET_COUNT');
    $result['result'] = 0;
    return $result;
  }
