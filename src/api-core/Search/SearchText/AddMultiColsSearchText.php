...
<?php include_once('Search/SearchText/AddSearchText/AddSearchTextCheckParams.php'); ?>
<?php include_once('Search/SearchText/AddSearchText/AddSearchTextDealWith.php'); ?>
<?php include_once('Search/SearchText/SerializeKeySearchText.php'); ?>
<?php include_once('Search/SearchText/SerializeColumnNameSearchText.php'); ?>
<?php include_once('Search/SearchText/SerializeColumnValueSearchText.php'); ?>
...
///////////
function AddMultiColsSearchText(&$params, $ttl = null, $is_check_params = true, $is_deal_with = true) {
  global $NoSQL;
  ...
  if(!isset($params['text_ids'])) {
    $result['error'] = ErrorCode('SEARCH_TEXT', $function_name, 'API1_NO_IDS');
    return $result;
  }
  ...
  foreach($params['text_ids'] as $each_val) {
    $params['text_id'] = $each_val;
    if($is_check_params && $result_check_params = AddSearchTextCheckParams($params)) {
