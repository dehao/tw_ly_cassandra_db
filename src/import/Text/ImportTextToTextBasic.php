...
<?php include_once('Text/ImportTextToTextBasic/ImportTextToTextBasicProcess.php'); ?>
<?php
/**********
 * ImportTextToTextBasic
 * @memo: (對於 ImportTextToTextBasic 的描述)
 *        (這個 function 做了哪些步驟)
 *
 ...
 * @TODO: 
 */
function ImportTextToTextBasic($argv) {
  global $NoSQL;
  ...
  ImportTextToTextBasicProcess($v2_st);
